    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f8f9fa" }} edges={["top"]}>
      ...
      <ScrollView ref={scrollViewRef} contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          <Text style={styles.headerTitle}>{editId ? "📝 Edit Product" : "Admin Panel"}</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={{flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginVertical: 10}}>
            ...
            {detailImages.length > 0 && (
               <View style={{flex: 1}}>
                  <Text style={styles.previewLabel}>Details ({detailImages.length}):</Text>
          ...
          <TouchableOpacity style={[styles.mainBtn, { backgroundColor: editId ? "#007BFF" : "#28a745" }]} onPress={handleSaveItem}>
            <Text style={styles.mainBtnText}>{editId ? "Update Now" : "Save Product"}</Text>
          </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.delBtn} onPress={() => {
                 Alert.alert("Delete", "Pakka?", [
                   ...
                   {text: "Yes", onPress: async () => {
                      const token = await getToken();
                      await axios.delete(`${API_URL}/api/items/${item.id}`, { headers: { Authorization: `Bearer ${token}` } });
                      fetchItems();
                   }}
                 ])
              }}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#fff", padding: 15, borderRadius: 20, elevation: 4 },
  ...
  removeImgBadge: { position: 'absolute', top: -5, right: -5, backgroundColor: 'red', width: 18, height: 18, borderRadius: 9, justifyContent: 'center', alignItems: 'center' },
  ...
  listItem: { flexDirection: "row", backgroundColor: "#fff", padding: 12, borderRadius: 15, marginBottom: 10, alignItems: "center", elevation: 2 },
  ...
  loaderCard: { backgroundColor: "#fff", padding: 25, borderRadius: 15, alignItems: "center" },
